    ...
    <section className="max-w-sm md:max-w-5xl lg:max-w-6xl xl:max-w-7xl m-auto px-5 mb-15 md:mb-20">
      ...
      <div className="">
        <ul className="border-l-2 h-full pl-10 border-[var(--color-flamingo)]/40">
          <li className="relative bg-[var(--color-background)] rounded-3xl p-6 md:p-10 mb-10 md:mb-15  shadow-md">
          ...
          <li className="relative bg-[var(--color-background)] rounded-2xl p-6 md:p-10 mb-10 md:mb-15 shadow-md">
            <div className="bg-white rounded-2xl p-6 md:p-10">
              <span className="absolute -top-1 -left-1 bg-[var(--color-flamingo)] w-5 h-5 rounded-full"></span>
              <div className="flex justify-between mb-2 md:mb-3">
          ...
          <li className="relative bg-[var(--color-background)] rounded-3xl p-6 md:p-10 shadow-md">
            <span className="absolute -top-1 -left-1 bg-[var(--color-flamingo)] w-5 h-5 rounded-full"></span>
            <ul>
              <li className="bg-gradient-to-r from-white to-[var(--color-background)] rounded-2xl p-6 md:p-10 mb-8 md:mb-12">
                <div className="flex justify-between mb-2 md:mb-3">
                  <span className="block font-semibold text-lg">交換留学</span>
                  <span className="block py-1 px-2 rounded-4xl bg-[var(--color-dark)]/20">
                    学歴
                  </span>
                </div>
              ...
              <li className="bg-white rounded-2xl p-6 md:p-10">
                <div className="flex justify-between mb-2 md:mb-3">
